...
<body style="padding-top:20px;">
	  ...
	  <table class="table table-bordered" cellpadding="0px" cellspacing="0px" border="1px" width="900px" >
	    ...
	    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr valign="middle" style="line-height:80px;" height="80">
			...
			<td valign="middle"><?php echo ($vo['don_name']); ?></td>
			<td><?php echo ($vo['don_mark']); ?></td>
			<td>¥<?php echo ($vo['don_num']); ?></td>
			<td><a href="__URL__/edit/id/<?php echo ($vo['don_id']); ?>"><img style="width:25px; height:25px;" title="编辑" src="__ROOT__/Admin/Common/images/news/edit.png" /></a></td>
			<td><a href="__URL__/del/id/<?php echo ($vo['don_id']); ?>"><img style="width:25px; height:25px;" title="删除" src="__ROOT__/Admin/Common/images/news/delete.png" /></a></td>		
