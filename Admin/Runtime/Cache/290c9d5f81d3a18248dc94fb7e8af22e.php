...
<script src="__ROOT__/Admin/Common/js/news/newslist.js"></script>
<div id="news">
	<table>
    	<tr>
    		<th width="40%">标题</th>
    		<th width="10%">发布人</th>
    		<th width="20%">发布时间</th>
			<?php if(($_SESSION['login'] == '006') OR ($_SESSION['login'] == '007')): ?><th width="6%">编辑</th>
    		    <th width="6%">删除</th><?php endif; ?>
    		<th width="6%">查看</th>
    	</tr>
	    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td><?php echo ($vo['news_title']); ?></td>
				<td><?php echo ($vo['news_publisher']); ?></td>
				<td><?php echo ($vo['news_date']); ?></td>
				
				<?php if(($_SESSION['login'] == '006') OR ($_SESSION['login'] == '007')): ?><td><a href="__URL__/edit/id/<?php echo ($vo['idmarch_news']); ?>">编辑</a></td>
				    <td><a href="__URL__/del/id/<?php echo ($vo['idmarch_news']); ?>/type/<?php echo ($vo['news_type']); ?>">删除</a></td><?php endif; ?>
				
				<td>
					<a target="_black" href="__ROOT__/index.php/News/show/nid/<?php echo ($vo['idmarch_news']); ?>">查看</a>
				</td>		
			</tr><?php endforeach; endif; else: echo "" ;endif; ?>
		<tr>
			<?php if(($_SESSION['login'] == '006') OR ($_SESSION['login'] == '007')): ?><td colspan="6">
				<input class="btn btn-primary" type="button" value="添加" onclick="window.location.href ='__URL__/addnews/addtype/<?php echo ($vo['news_type']); ?>'" style="margin-left:10px;" />
				<span id="selectnull" style="color:red; margin-left:10px; visibility:hidden;">(请选择要删除的项.)</span>
			   </td><?php endif; ?>
		</tr>
	</table>
