...
<body>
     <div id="con"> 
		  <h2 align="center">添加项目</h2>
		  <form name="form1" action="__URL__/submit" method="post" onSubmit="return check();" enctype="multipart/form-data">
		    <p>
			    标&nbsp;&nbsp;&nbsp;题: <input id="projecttitle" name="title" type="text" style="width:405px;" maxlength="50"/>
			</p>
			<p>
				类&nbsp;&nbsp;&nbsp;型: <input id="projecttype" name="type" type="text" style="width:150px; margin-right:50px;" maxlength="20"/>
				
				公&nbsp;&nbsp;司: <input id="projectcompany" name="company" type="text" style="width:150px;" maxlength="20"/>
			</p>
			<p>
				账&nbsp;&nbsp;&nbsp;户: <input id="projectaccount" name="account" type="text" style="width:150px; margin-right:50px;" maxlength="20"/>
				密&nbsp;&nbsp;码: <input id="projectpassword" name="password" type="text" style="width:150px;" maxlength="20"/>
			</p>
			...
			<P>
				文&nbsp;&nbsp;&nbsp;件: 			
				<input id="alink" name="link" style="width:300px; margin-left:10px;" type="text"/>
			...
			<p>
				<div style="width:800px;  height:200px;">
					...
					<div style="width:600px; height:200px; float:left;">
							<textarea id='content_1' name="content" style="width:600px;height:200px; "> </textarea>
					 </div>
				</div>
			</p>
			<p>
