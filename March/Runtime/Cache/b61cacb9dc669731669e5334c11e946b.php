...
<div id="blog">
	<div id="center">
		<div id="top">
			<ul>
				<li><a href="__URL__/blog" class="active">成员博客</a></li>
				<li><a href="__URL__/knowledge">知识库</a></li>
			</ul>
		</div>
		<div id="content">
			<?php if(is_array($list)): foreach($list as $key=>$val): ?><a href="<?php echo ($val["blog"]); ?>" target="_blank">
					<div class="user">
						<div class="float">
							<div class="photo">
								<img src="__ROOT__/Common/img/photo/photo/m_<?php echo (($val["avator"])?($val["avator"]):'fengmian.jpg'); ?>"/>
							</div>
						</div>
						<div class="info">
							<span class="name"><?php echo ($val["user_name"]); ?></span>
							<span class="class"><?php echo ($val["class"]); ?></span>
						</div>
					</div>
