...
<head>
	<link rel="stylesheet" type="text/css" href="__ROOT__/March/Common/css/photo/index.css">
</head>
<div id="div_center">
		<div id="div_pont"></div> 
		<div id="div_font_tit"><font id="font_fon"><big><b></b></big></font></div><div style="clear:both;"></div>
		<div id="div_line"></div>
	 	<div id="div_photo">
	 		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="alert alert-info" id="div_frame">
						<a href="__URL__/photo_list/idmarch_photo/<?php echo ($vo['idmarch_photo']); ?>">
							<img class="table-bordered" src="__ROOT__/Common/img/photo/s_<?php echo (($vo['photo_src'])?($vo['photo_src']):'fengmian.jpg'); ?>"><br></a>
						<font class="font_name"><b><?php echo ($vo['photo_name']); ?></b></font>
