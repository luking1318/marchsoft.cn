...
<head>  
	<link href="__ROOT__/March/Common/css/project/project.css" rel="stylesheet">
</head>
        ...
        <div class="content">
            ...
            <div class="left">
			   <div id="list_up" class="listitem"></div>
			   <a href="#a00" style="color:#3C3C3C; text-decoration:none;">
			   	<div id="firstitem" class="listitem"  >项目展示</div>
			   </a>
			     <div class="listitem_line"></div>
			   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#a<?php echo ($vo['idmarch_project']); ?>" style="color:#3C3C3C; text-decoration:none;">
					<div class="listitem"><?php echo ($vo['project_title']); ?></div>
					</a>
					<div class="listitem_line"></div><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="right">
			     ...
			     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pro">
						<span class="proImg"><a href="javascript:void(0);" class="thumb">
							<img src="<?php echo ($vo['project_img']); ?>" width="300" height="210" alt="图像" class="cover" /></a>
						</span>
						<span class="proInfo">
							<span class="proDesc">
							</span>
							<span class="prodetail">
								<span class="sp">【名称】： <a href="javascript:void(0);" style=""><?php echo ($vo['project_title']); ?></a></span> 
								<span class="sp">【类型】：<?php echo ($vo['project_type']); ?></span> 
								<span  class="sp">【公司】：<?php echo ($vo['project_company']); ?></span>
								<span class="sp">【查看】：<a href="javascript:void(0);" class="lk">演示地址</a>&nbsp;&nbsp;
									<label class="proUser">账户名:<?php echo ($vo['project_user']); ?> 密码：<?php echo ($vo['project_pwd']); ?></label>&nbsp; 
								</span>
							</span>
						</span>
						
						<span id='a<?php echo ($vo['idmarch_project']); ?>'></span>
                  </div> 
...
<script src="__ROOT__/March/Common/js/knowledge/knowledge.js" style="text/javascript"></script> 
<script src="__ROOT__/March/Common/js/project/project.js" style="text/javascript"></script> 
</BODY>
</HTML>