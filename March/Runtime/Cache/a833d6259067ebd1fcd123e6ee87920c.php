...
<div id="bk_r">
	<div id="news">
		<!--新闻标题-->
		<div id="n_tl"><?php echo ($result[0]['news_title']); ?></div>
		<!--新闻内容-->
		<div id="n_con">
			<div style="margin:10px 20px">
			【发布时间:<?php echo ($result[0]['news_date']); ?>&nbsp;&nbsp;
			  发布人:<?php echo ($result[0]['news_publisher']); ?>&nbsp;&nbsp;
			  阅读次数:<?php echo ($result[0]['news_num']); ?>】
			</div>
			<?php echo ($result[0]['news_content']); ?>
		</div>
