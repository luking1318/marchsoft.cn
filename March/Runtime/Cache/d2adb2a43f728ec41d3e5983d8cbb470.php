...
<input type="hidden" value="0" id="btn_bool">
 ...
 <center id='centerOne'>
  <div id="main">
	...
	<head>  
		<link href="__ROOT__/March/Common/css/introduce/introteacher.css" rel="stylesheet">
	</head>
	...
	<div id="intro_con">
	    <table cellpadding="0" cellspacing="0" width="100%" >
			<tr>
				<td><div id="con_left"><?php echo ($intro); ?></div></td>
				<td valign="top"><div id="con_right"></div></td>
			</tr>
		</table>	
