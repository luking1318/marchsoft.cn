...
<input type="hidden" class="nav" value="0">
	...
	<div id="intro_top">
		...
		<!-- </div> -->
		<!--捐赠三月-->
		<div class="intro_item" style="background:none"><a href="__ROOT__/index.php/Pay">
			<div align="left"><img style="width: 250px;" src="__ROOT__/March/Common/img/index/paylogo.png" alt=""></div>
			<!-- <div>捐赠三月</div> -->
			<div class="intro_con" style="margin-top:13px;margin-left:20px;padding-left:0px;line-height:18px;color:black;">
				<p>不忘初心，梦开始的地方。</p>
				<p>种下一棵树，收获一片绿荫；</p>
				<p>献出一份爱心，托起一份希望。</p>
				<p>您的帮助是对我们最大的支持和动力！</p>
			</div>

		</a>
			<div class="morecon">
				<a href="__ROOT__/index.php/Pay" target="_blank">我要捐款</a>
			</div>
